...
def test_workflow():
  ...
  config_dict.get("project").update({"project_dir":"S00_P00_Participant\S00_P00_T00_StaticTrial"})
  ...
  # config_dict.get("project").update({"project_dir":"S00_P00_Participant\S00_P00_T00_BalancingTrial"})
  # config_dict['filtering']['display_figures'] = False
  # # Pose2Sim.poseEstimation(config_dict)
  # # Pose2Sim.synchronization(config_dict)
  # Pose2Sim.personAssociation(config_dict)
